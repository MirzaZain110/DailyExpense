...
import { getEntries, addEntry, deleteEntry } from '../utils/storage';
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.emptyText}>
            No entries yet. Use the buttons below to add income or expense.
          </Text>
        }
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.entryCard} onLongPress={() => handleDeleteEntry(item)}>
            <View style={styles.entryLeft}>
              ...
              <View style={{ flexShrink: 1 }}>
                <Text style={styles.entryPerson}>
                  {item.person ? item.person : item.type === 'income' ? 'Income' : 'Expense'}
                </Text>
